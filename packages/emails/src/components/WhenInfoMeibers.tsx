...
export function WhenInfoMeibers(props: {
  ...
  function getRecipientStart(format: string) {
    let rStart =  dayjs(props.calEvent.startTime).tz(timeZone).locale(locale).format(format);
    let sanitizedWhenString = rStart.toString();
    let sanitizedWhen = sanitizedWhenString.replace(/[-]/gi,"bis");

    return sanitizedWhen.replace(/\|\s/gi,"\r\n");
